...
<div class="container mt-3">
	@if($card && $card->user)
    <h1>Info for your gym card: <span style="color: darkblue;">{{ $card->user->name }}</span></h1>

  
  <div class="card" style="width:400px">
    <img class="card-img-top" src="{{ public_path('members_img/'.$card->profile) }}" alt="Card image" style="width:100%">
    <div class="card-body">
