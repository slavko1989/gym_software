 @props(['edit','cats','comps'])
  ...
  <p style='color: darkblue;'>Update trainer</p>  
...
<form action="{{ url('trainers/edit/'.$edit->id) }}" method="post" enctype="multipart/form-data">
    @csrf
  <div class="mb-3 mt-3">
  ...
  <div class="mb-3 mt-3">
    ...
    @error('profile')
        <p style="color: black;">{{ $message }}</p>
    @enderror
    <img class="card-img-top" src="{{ asset('trainers_img/'. $edit->profile) }}" alt="Card image" style="width:80px;height:80px;">
  </div>
